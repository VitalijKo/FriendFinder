...
def update_db(age, sex):
    top_users = api.users.search(sex=sex,
                                 count=1000,
                                 age_from=age - 1,
                                 age_to=age + 1,
                                 has_photo=1,
                                 fields='can_write_private_message')['items']
                                ...
                                if msg == 'жалобы' and user_id == admin_id:
                                    ...
                                    if str(user_id) in queue:
                                        if queue[str(user_id)]['end']:
                                            ...
                                            send(user_id, 'Поздравляем с нахождением хэш-пары! У вас имеются действия:\n'
                                    ...
                                    if str(user_id) in registration and registration[str(user_id)]['sex'] == 0:
                                        ...
                                        send(user_id, 'Теперь отправьте свой возраст (минимум 15, максимум 19)', clear_key)

                                    elif str(user_id) in queue:
                                        if queue[str(user_id)]['sex'] is None:
                                            queue[str(user_id)]['sex'] = 0

                                            send(user_id, 'Отправьте примерный возраст хэш-пары (минимум 16, максимум 18)',
                                                 clear_key)
                                    ...
                                    if str(user_id) in registration and registration[str(user_id)]['sex'] != 0:
                                        try:
                                            ...
                                            send(user_id, 'Некорректный возраст! &#10060;', clear_key)
                                            send(user_id, 'Отправьте свой возраст в виде числа (минимум 15, максимум 19)')
...
if __name__ == '__main__':
    ...
    male_first_names = ['Александр', 'Алексей', 'Альберт', 'Анатолий', 'Андрей', 'Антон', 'Арсен', 'Арсений',
    ...
    female_first_names = ['Агата', 'Александра', 'Алена', 'Алина', 'Алиса', 'Альбина', 'Амина', 'Анастасия',
    ...
    male_last_names = ['Иванов', 'Петров', 'Смирнов', 'Кузнецов', 'Васильев', 'Попов', 'Волков', 'Андреев', 'Сергеев',
    ...
    female_last_names = ['Иванова', 'Петрова', 'Смирнова', 'Кузнецова', 'Васильева', 'Попова', 'Новикова', 'Волкова',
